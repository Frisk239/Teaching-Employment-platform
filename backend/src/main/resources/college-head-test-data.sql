...
-- 1. 创建学院负责人账号（如果不存在）
-- ================================================================
INSERT INTO t_user (username, password, real_name, phone, email, role_id, school_id, status, gender, avatar)
VALUES ('college01', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李院长', '13800001001', 'college01@test.com', 2, 1, 1, 1, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png')
...
INSERT INTO t_user (username, password, real_name, phone, email, role_id, school_id, status, gender, avatar)
VALUES
('teacher01', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王强', '13800002001', 'teacher01@test.com', 3, 1, 1, 1, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'),
('teacher02', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李娜', '13800002002', 'teacher02@test.com', 3, 1, 1, 2, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'),
('teacher03', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张伟', '13800002003', 'teacher03@test.com', 3, 1, 1, 1, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'),
('teacher04', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '刘芳', '13800002004', 'teacher04@test.com', 3, 1, 1, 2, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png'),
('teacher05', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '陈明', '13800002005', 'teacher05@test.com', 3, 1, 1, 1, 'https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png');
...
-- 创建学生账号（30个学生）
INSERT INTO t_user (username, password, real_name, phone, email, role_id, school_id, status, gender)
VALUES
('student01', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张三', '13900001001', 'student01@test.com', 4, 1, 1, 1),
('student02', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李四', '13900001002', 'student02@test.com', 4, 1, 1, 2),
('student03', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王五', '13900001003', 'student03@test.com', 4, 1, 1, 1),
('student04', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '赵六', '13900001004', 'student04@test.com', 4, 1, 1, 2),
('student05', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '钱七', '13900001005', 'student05@test.com', 4, 1, 1, 1),
('student06', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '孙八', '13900001006', 'student06@test.com', 4, 1, 1, 2),
('student07', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '周九', '13900001007', 'student07@test.com', 4, 1, 1, 1),
('student08', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '吴十', '13900001008', 'student08@test.com', 4, 1, 1, 2),
('student09', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '郑十一', '13900001009', 'student09@test.com', 4, 1, 1, 1),
('student10', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王小二', '13900001010', 'student10@test.com', 4, 1, 1, 2),
('student11', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李小三', '13900001011', 'student11@test.com', 4, 1, 1, 1),
('student12', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张小四', '13900001012', 'student12@test.com', 4, 1, 1, 2),
('student13', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '刘小五', '13900001013', 'student13@test.com', 4, 1, 1, 1),
('student14', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '陈小六', '13900001014', 'student14@test.com', 4, 1, 1, 2),
('student15', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '杨小七', '13900001015', 'student15@test.com', 4, 1, 1, 1),
('student16', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '黄小八', '13900001016', 'student16@test.com', 4, 1, 1, 2),
('student17', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '赵小九', '13900001017', 'student17@test.com', 4, 1, 1, 1),
('student18', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '吴小十', '13900001018', 'student18@test.com', 4, 1, 1, 2),
('student19', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '周小一', '13900001019', 'student19@test.com', 4, 1, 1, 1),
('student20', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '徐小二', '13900001020', 'student20@test.com', 4, 1, 1, 2),
('student21', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '孙小三', '13900001021', 'student21@test.com', 4, 1, 1, 1),
('student22', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '马小四', '13900001022', 'student22@test.com', 4, 1, 1, 2),
('student23', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '朱小五', '13900001023', 'student23@test.com', 4, 1, 1, 1),
('student24', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '胡小六', '13900001024', 'student24@test.com', 4, 1, 1, 2),
('student25', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '林小七', '13900001025', 'student25@test.com', 4, 1, 1, 1),
('student26', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '何小八', '13900001026', 'student26@test.com', 4, 1, 1, 2),
('student27', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '高小九', '13900001027', 'student27@test.com', 4, 1, 1, 1),
('student28', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '罗小十', '13900001028', 'student28@test.com', 4, 1, 1, 2),
('student29', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '梁一一', '13900001029', 'student29@test.com', 4, 1, 1, 1),
('student30', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '宋一二', '13900001030', 'student30@test.com', 4, 1, 1, 2);
...
SELECT
    ...
    1,
    CASE (id % 3)
        WHEN 1 THEN '计算机科学与技术1班'
        WHEN 2 THEN '计算机科学与技术2班'
        ELSE '软件工程1班'
    END,
    CASE (id % 2)
        WHEN 1 THEN '计算机科学与技术'
        ELSE '软件工程'
    END,
    '2021级',
    gender,
...
SELECT
    ...
    END,
    'active',
    (SELECT id FROM t_user WHERE username = 'enterprise01' LIMIT 1)
FROM t_company
WHERE company.id <= 10
...
SELECT
    ...
    CASE (s.id % 10)
        ...
        ELSE 'pending'
    END,
    DATE_ADD('2024-01-01', INTERVAL s.id DAY)
FROM t_student s
...
SELECT
    s.id,
    DATE_SUB(CURDATE(), INTERVAL (s.id % 30) DAY),
    CONCAT('今日学习了', CASE (s.id % 5)
        WHEN 0 THEN '数据结构'
        WHEN 1 THEN '算法'
        WHEN 2 THEN '数据库'
        WHEN 3 THEN '前端开发'
...
AND NOT EXISTS (
    ...
    AND dr.report_date = DATE_SUB(CURDATE(), INTERVAL (s.id % 30) DAY)
);
...
SELECT
    c.id,
    CONCAT(c.course_name, ' - 作业', (c.id % 5) + 1),
...
AND NOT EXISTS (
    ...
    AND h.title = CONCAT(c.course_name, ' - 作业', (c.id % 5) + 1)
);
