...
public class ExcelUtil {
    ...
    @HeadRowHeight(30)
    @ColumnWidth(20)
    public static class TeacherImportTemplate {
        ...
        @ExcelProperty(value = "所属学校", index = 7)
        private String schoolName;
        ...
        @ExcelProperty(value = "专业领域", index = 11)
        private String specialty;

        @ExcelProperty(value = "入职日期", index = 12)
        private String entryDate;

        @ExcelProperty(value = "家庭地址", index = 13)
        private String address;
    ...
    @HeadRowHeight(30)
    @ColumnWidth(20)
    public static class TeacherExportTemplate {
