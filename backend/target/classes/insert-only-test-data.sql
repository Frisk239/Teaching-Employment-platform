...
-- 1. 插入用户测试数据 (使用INSERT IGNORE避免重复)
INSERT IGNORE INTO t_user (id, username, password, real_name, phone, email, role_id, status, create_time, update_time) VALUES
...
-- 2. 插入学生测试数据
INSERT IGNORE INTO t_student (id, user_id, student_no, gender, phone, email, grade, major, class_name, enrollment_date, create_time, update_time) VALUES
...
-- 3. 插入企业测试数据
INSERT IGNORE INTO t_company (id, company_name, industry, scale, location, website, description, contact_person, contact_phone, contact_email, status, create_time, update_time) VALUES
...
-- 4. 插入职位测试数据
INSERT IGNORE INTO t_position (id, company_id, position_name, position_type, salary_min, salary_max, location, requirements, description, recruitment_count, status, create_time, update_time) VALUES
...
-- 6. 插入课程学生关联数据
INSERT IGNORE INTO t_course_student (course_id, student_id, enrollment_date, status, create_time, update_time) VALUES
...
-- 7. 插入求职申请测试数据
INSERT IGNORE INTO t_job_application (student_id, position_id, company_id, resume_id, status, apply_time, create_time, update_time) VALUES
...
INSERT IGNORE INTO t_offer (student_id, position_id, company_id, salary, offer_date, status, create_time, update_time) VALUES
...
-- 9. 插入公告测试数据
INSERT IGNORE INTO t_notification (user_id, type, title, content, related_id, is_read, read_time, create_time, update_time) VALUES
