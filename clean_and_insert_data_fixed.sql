...
-- 删除ID 1-8的学生记录
DELETE FROM t_student WHERE id BETWEEN 1 AND 8;

-- 删除ID 60-67的用户记录(避免与其他记录冲突)
DELETE FROM t_user WHERE id BETWEEN 60 AND 67;

-- 删除ID 1-8的简历记录
DELETE FROM t_resume WHERE id BETWEEN 1 AND 8;
...
(60, 'test_student_01', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '张三', '13800138001', 'zhangsan@example.com', 5, 1, 1, NOW(), NOW()),
(61, 'test_student_02', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '李四', '13800138002', 'lisi@example.com', 5, 1, 1, NOW(), NOW()),
(62, 'test_student_03', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '王五', '13800138003', 'wangwu@example.com', 5, 1, 1, NOW(), NOW()),
(63, 'test_student_04', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '赵六', '13800138004', 'zhaoliu@example.com', 5, 1, 1, NOW(), NOW()),
(64, 'test_student_05', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '孙七', '13800138005', 'sunqi@example.com', 5, 1, 1, NOW(), NOW()),
(65, 'test_student_06', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '周八', '13800138006', 'zhouba@example.com', 5, 1, 1, NOW(), NOW()),
(66, 'test_student_07', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '吴九', '13800138007', 'wujiu@example.com', 5, 1, 1, NOW(), NOW()),
(67, 'test_student_08', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', '郑十', '13800138008', 'zhengshi@example.com', 5, 1, 1, NOW(), NOW());
...
(1, 60, '2021001', 1, 'CS2101', 'Computer Science', '2021', 1, '2000-05-15', '110101200005151234', '13800138001', 'zhangsan@example.com', 'Beijing', '2021-09-01', '2025-06-30', 'Member', 'Han', 'Zhang Father', '13900000001', 0, NOW(), NOW()),
(2, 61, '2021002', 1, 'CS2101', 'Computer Science', '2021', 1, '2000-08-22', '110102200008221234', '13800138002', 'lisi@example.com', 'Shanghai', '2021-09-01', '2025-06-30', 'Party Member', 'Han', 'Li Father', '13900000002', 0, NOW(), NOW()),
(3, 62, '2021003', 1, 'SE2101', 'Software Engineering', '2021', 2, '2001-03-10', '110103200103101234', '13800138003', 'wangwu@example.com', 'Guangzhou', '2021-09-01', '2025-06-30', 'Member', 'Han', 'Wang Father', '13900000003', 0, NOW(), NOW()),
(4, 63, '2021004', 1, 'SE2101', 'Software Engineering', '2021', 1, '2000-11-28', '110104200011281234', '13800138004', 'zhaoliu@example.com', 'Shenzhen', '2021-09-01', '2025-06-30', 'Mass', 'Han', 'Zhao Father', '13900000004', 0, NOW(), NOW()),
(5, 64, '2021005', 1, 'CS2102', 'Computer Science', '2021', 2, '2001-06-05', '110105200106051234', '13800138005', 'sunqi@example.com', 'Hangzhou', '2021-09-01', '2025-06-30', 'Member', 'Han', 'Sun Father', '13900000005', 0, NOW(), NOW()),
(6, 65, '2021006', 1, 'CS2102', 'Computer Science', '2021', 1, '2000-09-18', '110106200009181234', '13800138006', 'zhouba@example.com', 'Chengdu', '2021-09-01', '2025-06-30', 'Member', 'Han', 'Zhou Father', '13900000006', 0, NOW(), NOW()),
(7, 66, '2021007', 1, 'SE2102', 'Software Engineering', '2021', 2, '2001-01-30', '110107200101301234', '13800138007', 'wujiu@example.com', 'Nanjing', '2021-09-01', '2025-06-30', 'Mass', 'Han', 'Wu Father', '13900000007', 0, NOW(), NOW()),
(8, 67, '2021008', 1, 'SE2102', 'Software Engineering', '2021', 1, '2000-12-12', '110108200012121234', '13800138008', 'zhengshi@example.com', 'Wuhan', '2021-09-01', '2025-06-30', 'Member', 'Han', 'Zheng Father', '13900000008', 0, NOW(), NOW());
...
SELECT '用户表记录数:' AS description, COUNT(*) AS count FROM t_user WHERE id BETWEEN 60 AND 67
UNION ALL
SELECT '学生表记录数:', COUNT(*) FROM t_student WHERE id BETWEEN 1 AND 8
UNION ALL
SELECT '学生表有userId的记录数:', COUNT(*) FROM t_student WHERE id BETWEEN 1 AND 8 AND user_id IS NOT NULL
UNION ALL
SELECT '简历表记录数:', COUNT(*) FROM t_resume WHERE id BETWEEN 1 AND 8
UNION ALL
SELECT '求职申请表记录数:', COUNT(*) FROM t_job_application
UNION ALL
SELECT '求职申请中学生记录完整的数量:', COUNT(*) FROM t_job_application ja
INNER JOIN t_student s ON ja.student_id = s.id
